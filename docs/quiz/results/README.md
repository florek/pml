...
- **Najgorszy wynik:** 18/20 (90%) — 19.04.2026, 20.04.2026
- **Średnia ze wszystkich prób:** 18,33/20 (91,67%)
- **Ostatnie 5 wyników:** 18/20 (20.04.2026), 18/20 (19.04.2026), 19/20 (15.04.2026)

## Najczęstsze obszary do poprawy

Na podstawie wszystkich plików `*_results.md` (łącznie 3 próby):

| Kategoria (tag) | Liczba błędów |
|-----------------|---------------|
| [ML] | 6 |

W trzech quizach powtarza się wzorzec: wpisanie „X” zamiast litery A–D (traktowane jak brak ważnej odpowiedzi). Warto konsekwentnie wybierać jedną literę z wariantów.
